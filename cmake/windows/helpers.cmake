...
function(set_target_properties_plugin target)
  ...
  file(READ "${CMAKE_SOURCE_DIR}/buildspec.json" _buildspec_json)
  string(JSON PLUGIN_AUTHOR GET "${_buildspec_json}" author)
  string(JSON PLUGIN_WEBSITE ERROR_VARIABLE _ws_err GET "${_buildspec_json}" website)
  if(_ws_err)
    set(PLUGIN_WEBSITE "https://example.com")
  endif()

  configure_file(cmake/windows/resources/installer.iss.in "${CMAKE_CURRENT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.iss" @ONLY)
endfunction()
